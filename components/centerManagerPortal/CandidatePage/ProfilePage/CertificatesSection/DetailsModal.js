      ...
      <Modal isOpen={this.props.isOpen} toggle={this.props.toggle} className='modal-lg modal-info'>
        ...
        <ModalBody>
            <FormGroup>
              ...
              <Input onChange={(e)=>this.handleFieldChange('name', e.target.value)} defaultValue={this.state.name} type="text" id="name" placeholder="Eg: Manager" required disabled/>
            </FormGroup>
            <FormGroup>
              <Label htmlFor="name">Certification Authority</Label>
              <Input onChange={(e)=>this.handleFieldChange('authority', e.target.value)} defaultValue={this.state.authority} type="text" id="name" placeholder="Eg: Google" required disabled/>
            </FormGroup>
            <FormGroup>
              <Label htmlFor="name">License Number</Label>
              <Input onChange={(e)=>this.handleFieldChange('licenseNumber', e.target.value)} defaultValue={this.state.licenseNumber} type="text" id="name" placeholder="Eg: Google" required disabled/>
            </FormGroup>
            <FormGroup row>
              <Col md="6">
                <Label htmlFor="name">From</Label>
                <Input onChange={(e)=>this.handleFieldChange('fromMonth', e.target.value)} type="select" id="name" style={{marginBottom: '10px'}} placeholder="Month"  required disabled defaultValue={this.state.fromMonth}>
              ...
              {(!this.state.doesNotExpire) && (
                <Col md="6">
                  ...
                  <Input onChange={(e)=>this.handleFieldChange('toMonth', e.target.value)} type="select" id="name" style={{marginBottom: '10px'}} placeholder="Month"  required disabled defaultValue={this.state.toMonth}>
                    {MONTHS.map((month, i)=><option key={i}>{month}</option>)}
                  </Input>
            ...
            <FormGroup check className="checkbox">
              <Input className="form-check-input" type="checkbox" id="checkbox1" name="checkbox1" disabled defaultChecked={this.state.doesNotExpire} onClick={this.toggleCheck}/>
            ...
            <FormGroup>
              ...
              <InputGroup>
                ...
                {/* <Input onChange={(e)=>this.handleFieldChange('salary', e.target.value)} defaultValue={this.state.salary} type="text" id="name" placeholder="Eg: $30 billion for the account" required disabled/> */}
                <Input onChange={(e)=>this.handleFieldChange('url', e.target.value)} defaultValue={this.state.url} type="text" id="name" placeholder="Eg: Google" required disabled/>
              </InputGroup>
            </FormGroup>
        </ModalBody>
        <ModalFooter>
